    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <section class="border rounded p-5 mt-5 ">
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <form class="row g-3"
                        action="{{ isset($website) && !empty($website) ? route('publisher.website.update', $website->id) : route('publisher.website.store') }}"
                        method="Post" id="addWebsiteForm" enctype="multipart/form-data">
                        @csrf
                        @if (!isset($website) || empty($website))
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control @error('website_url') is-invalid @enderror"
                                    id="inputWebUrl" name="website_url" required placeholder="https://example.com"
                                    value="{{ old('website_url') }}" autofocus>
                                @error('website_url')
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control" id="inputDomainAuthority" name="domain_authority"
                                mix="1" max="100"
                                value="{{ isset($domain_authority) && !empty($domain_authority) ? $domain_authority : 1 }}"
                                placeholder="DA (domain Authority)">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control" id="inputPageAuthority" name="page_authority"
                                mix="1" max="100"
                                value="{{ isset($page_authority) && !empty($page_authority) ? $page_authority : 1 }}"
                                placeholder="PA (Page Authority)">
                        </div>
                        <div class="col-md-4">
                            <?php
                            if (old('spam_score')) {
                            ...
                            <input type="number" class="form-control" id="inputSpamScore" name="spam_score" mix="0"
                                max="100" value="{{ isset($spam_score) && !empty($spam_score) ? $spam_score : 1 }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <select id="inputPublishingTime" class="select2 form-select" name="publishing_time"
                                ...
                                <option value=""
                                    {{ !isset($publishing_time) || empty($publishing_time) ? 'selected' : '' }}>Select
                                    Day</option>
                                <option value="1"
                                    {{ !empty($publishing_time) && $publishing_time == 1 ? 'selected' : '' }}>1 Days
                                </option>
                                <option value="2"
                                    {{ !empty($publishing_time) && $publishing_time == 2 ? 'selected' : '' }}>2 Days
                                </option>
                                <option value="3"
                                    {{ !empty($publishing_time) && $publishing_time == 3 ? 'selected' : '' }}>3 Days
                                </option>
                                <option value="4"
                                    {{ !empty($publishing_time) && $publishing_time == 4 ? 'selected' : '' }}>4 Days
                                </option>
                                <option value="5"
                                    {{ !empty($publishing_time) && $publishing_time == 5 ? 'selected' : '' }}>5 Days
                                </option>
                                <option value="6"
                                    {{ !empty($publishing_time) && $publishing_time == 6 ? 'selected' : '' }}>6 Days
                                </option>
                                <option value="7"
                                    {{ !empty($publishing_time) && $publishing_time == 7 ? 'selected' : '' }}>7 Days
                                </option>
                                <option value="8"
                                    {{ !empty($publishing_time) && $publishing_time == 8 ? 'selected' : '' }}>8 Days
                                </option>
                                <option value="9"
                                    {{ !empty($publishing_time) && $publishing_time == 9 ? 'selected' : '' }}>9 Days
                                </option>
                                <option value="10"
                                    {{ !empty($publishing_time) && $publishing_time == 10 ? 'selected' : '' }}>10 Days
                                </option>
                                <option value="11"
                                    {{ !empty($publishing_time) && $publishing_time == 11 ? 'selected' : '' }}>11 Days
                                </option>
                                <option value="12"
                                    {{ !empty($publishing_time) && $publishing_time == 12 ? 'selected' : '' }}>12 Days
                                </option>
                                <option value="13"
                                    {{ !empty($publishing_time) && $publishing_time == 13 ? 'selected' : '' }}>13 Days
                                </option>
                                <option value="14"
                                    {{ !empty($publishing_time) && $publishing_time == 14 ? 'selected' : '' }}>14 Days
                                </option>
                                <option value="15"
                                    {{ !empty($publishing_time) && $publishing_time == 15 ? 'selected' : '' }}>15 Days
                                </option>
                                <option value="60"
                                    {{ !empty($publishing_time) && $publishing_time == 60 ? 'selected' : '' }}>60 Days
                                </option>
                            </select>
                        </div>
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control" id="inputWordCount"
                                value="{{ isset($minimum_word_count_required) && !empty($minimum_word_count_required) ? $minimum_word_count_required : 1 }}"
                                name="minimum_word_count_required">
                        </div>
                        <div class="col-md-4">
                            <?php
                            ...
                            <div class="row bg-light rounded p-2 w-75 mx-2">
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="backlink_type"
                                            id="inputBacklinkType1" value="dofollow"
                                            {{ !empty($backlink_type) && $backlink_type == 'dofollow' ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="backlink_type"
                                            id="inputBacklinkType2" value="nofollow"
                                            {{ (!empty($backlink_type) && $backlink_type == 'nofollow') || !isset($backlink_type) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-4">
                            ...
                            <select id="inputBacklinksAllowed" class="select2 form-select"
                                name="maximum_no_of_backlinks_allowed" data-allow-clear="true">
                                <option value=""
                                    {{ !isset($maximum_no_of_backlinks_allowed) || empty($maximum_no_of_backlinks_allowed) ? 'selected' : '' }}>
                                    Select number of link</option>
                                <option value="1"
                                    {{ !empty($maximum_no_of_backlinks_allowed) && $maximum_no_of_backlinks_allowed == '1' ? 'selected' : '' }}>
                                    1</option>
                                <option value="2"
                                    {{ !empty($maximum_no_of_backlinks_allowed) && $maximum_no_of_backlinks_allowed == '2' ? 'selected' : '' }}>
                                    2</option>
                                <option value="3"
                                    {{ !empty($maximum_no_of_backlinks_allowed) && $maximum_no_of_backlinks_allowed == '3' ? 'selected' : '' }}>
                                    3</option>
                                <option value="4"
                                    {{ !empty($maximum_no_of_backlinks_allowed) && $maximum_no_of_backlinks_allowed == '4' ? 'selected' : '' }}>
                                    4</option>
                                <option value="5"
                                    {{ !empty($maximum_no_of_backlinks_allowed) && $maximum_no_of_backlinks_allowed == '5' ? 'selected' : '' }}>
                                    5</option>
                                <option value="5+"
                                    {{ !empty($maximum_no_of_backlinks_allowed) && $maximum_no_of_backlinks_allowed == '5+' ? 'selected' : '' }}>
                                    5+</option>
                        ...
                        <div class="col-md-4">
                            ...
                            <select id="inputDomainLifeValidity" class="form-select select2" name="domain_life_validity"
                                data-allow-clear="true">
                                <option value=""
                                    {{ !isset($domain_life_validity) || empty($domain_life_validity) ? 'selected' : '' }}>
                                    Select domain life validity</option>
                                <option value="Permanent"
                                    {{ !empty($domain_life_validity) && $domain_life_validity == 'Permanent' ? 'selected' : '' }}>
                                    Permanent</option>
                                <option value="Atleast for 1 year"
                                    {{ !empty($domain_life_validity) && $domain_life_validity == 'Atleast for 1 year' ? 'selected' : '' }}>
                                    Atleast for 1 year</option>
                                <option value="Atleast for 2 years"
                                    {{ !empty($domain_life_validity) && $domain_life_validity == 'Atleast for 2 years' ? 'selected' : '' }}>
                                    Atleast for 2 years</option>
                            </select>
                        </div>
                        <!-- <div class="col-md-4">
                            @php
                                if (old('traffic_by_country')) {
                                    ...
                                    isset($website->traffic_by_country)
                                        ? ($traffic_by_country = $website->traffic_by_country)
                                        : '';
                                }
                                $FCarr = [];
                            ...
                            <div class="select2-primary">
                                <select id="inputCategories1" name="categories[]" class="form-select select2" multiple>
                                    ...
                                    <option value="Animals & Pets"
                                        {{ in_array('Animals & Pets', $Carr) ? 'selected' : '' }}>Animals & Pets</option>
                                    <option value="Arms and ammunition"
                                        {{ in_array('Arms and ammunition', $Carr) ? 'selected' : '' }}>Arms and ammunition
                                    </option>
                                    <option value="Arts & Entertainment"
                                        {{ in_array('Arts & Entertainment', $Carr) ? 'selected' : '' }}>Arts &
                                        Entertainment</option>
                                    <option value="Automobiles" {{ in_array('Automobiles', $Carr) ? 'selected' : '' }}>
                                        Automobiles</option>
                                    <option value="Beauty" {{ in_array('Beauty', $Carr) ? 'selected' : '' }}>Beauty
                                    </option>
                                    <option value="Blogging" {{ in_array('Blogging', $Carr) ? 'selected' : '' }}>
                                        Blogging
                                    </option>
                                    <option value="Business" {{ in_array('Business', $Carr) ? 'selected' : '' }}>
                                        Business
                                    </option>
                                    <option value="Career & Employment"
                                        {{ in_array('Career & Employment', $Carr) ? 'selected' : '' }}>
                                        Career & Employment</option>
                                    <option value="Computer & Electronics"
                                        {{ in_array('Computer & Electronics', $Carr) ? 'selected' : '' }}>
                                        Computer & Electronics</option>
                                    <option value="Coupons Offers & Cashback"
                                        {{ in_array('Coupons Offers & Cashback', $Carr) ? 'selected' : '' }}>
                                        Coupons Offers & Cashback</option>
                                    <option value="Digital Marketing"
                                        {{ in_array('Digital Marketing', $Carr) ? 'selected' : '' }}>
                                    ...
                                    <option value="Fashion & Lifestyle"
                                        {{ in_array('Fashion & Lifestyle', $Carr) ? 'selected' : '' }}>
                                        Fashion & Lifestyle</option>
                                    <option value="Finance" {{ in_array('Finance', $Carr) ? 'selected' : '' }}>Finance
                                    </option>
                                    <option value="Food & Drink"
                                        {{ in_array('Food & Drink', $Carr) ? 'selected' : '' }}>
                                        Food & Drink</option>
                                    <option value="Games" {{ in_array('Games', $Carr) ? 'selected' : '' }}>Games
                                    </option>

                                    <option value="Gift" {{ in_array('Gift', $Carr) ? 'selected' : '' }}>Gift</option>
                                    <option value="Health & Fitness"
                                        {{ in_array('Health & Fitness', $Carr) ? 'selected' : '' }}>
                                        Health & Fitness</option>
                                    <option value="Home & Garden"
                                        {{ in_array('Home & Garden', $Carr) ? 'selected' : '' }}>Home & Garden</option>
                                    <option value="Humor" {{ in_array('Humor', $Carr) ? 'selected' : '' }}>Humor
                                    </option>
                                    <option value="Internet & Telecom"
                                        {{ in_array('Internet & Telecom', $Carr) ? 'selected' : '' }}>
                                        Internet & Telecom</option>
                                    <option value="Law & Government"
                                        {{ in_array('Law & Government', $Carr) ? 'selected' : '' }}>
                                        Law & Government</option>
                                    <option value="Leisure & Hobbies"
                                        {{ in_array('Leisure & Hobbies', $Carr) ? 'selected' : '' }}>
                                        Leisure & Hobbies</option>
                                    <option value="Magazine" {{ in_array('Magazine', $Carr) ? 'selected' : '' }}>
                                        Magazine
                                    </option>
                                    <option value="Manufacturing"
                                        {{ in_array('Manufacturing', $Carr) ? 'selected' : '' }}>Manufacturing</option>
                                    <option value="Marketing & Advertising"
                                        {{ in_array('Marketing & Advertising', $Carr) ? 'selected' : '' }}>
                                        Marketing & Advertising</option>
                                    <option value="Music" {{ in_array('Music', $Carr) ? 'selected' : '' }}>Music
                                    </option>
                                    <option value="News & Media"
                                        {{ in_array('News & Media', $Carr) ? 'selected' : '' }}>
                                        News & Media</option>
                                    ...
                                    <option value="Real estate" {{ in_array('Real estate', $Carr) ? 'selected' : '' }}>
                                        Real
                                        estate</option>
                                    ...
                                    <option value="Web development"
                                        {{ in_array('Web development', $Carr) ? 'selected' : '' }}>Web development
                                    </option>
                                    <option value="Wedding" {{ in_array('Wedding', $Carr) ? 'selected' : '' }}>Wedding
                                    </option>
                                    <option value="Services" {{ in_array('Services', $Carr) ? 'selected' : '' }}>
                                        Services
                                    </option>
                        ...
                        <div class="col-md-6 mb-4">
                            @php
                                if (old('forbidden_categories')) {
                                    ...
                                    isset($website->forbidden_categories)
                                        ? ($forbidden_categories = $website->forbidden_categories)
                                        : '';
                                }
                                $FCarr = [];
                                if (isset($forbidden_categories) && !empty($forbidden_categories)) {
                                    $FCarr = explode(',', $forbidden_categories);
                                }
                            @endphp
                            ...
                            <div class="select2-info">
                                ...
                                <select id="inputForbiddenCategories1" name="forbidden_categories[]"
                                    ...
                                    <option value="CBD/Marijuana"
                                        {{ in_array('CBD/Marijuana', $FCarr) ? 'selected' : '' }}>CBD/Marijuana</option>
                                    <option value="Cryptocurrency"
                                        {{ in_array('Cryptocurrency', $FCarr) ? 'selected' : '' }}>Cryptocurrency
                                    </option>
                                    <option value="Vape" {{ in_array('Vape', $FCarr) ? 'selected' : '' }}>Vape
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 mb-2">
                            ...
                            <input type="file" name="site_verification_file" id="site_verification_file"
                                class="form-control"
                                {{ isset($site_verification_file) && !empty($site_verification_file) ? '' : 'required' }}
                                accept=".pdf">
                            ...
                            <div id="file-error" class="text-danger" style="display: none;">Only PDF files are allowed.
                            </div>
                        </div>
                        <div class="col-md-6 mb-2">

                            <div class="form-check">
                                <label class="form-check-label" for="inputReadedGuide">The post will be Google Indexed
                                </label>
                                <input class="form-check-input" type="checkbox" name="Google" id="Google"
                                    value="yes" required>

                            </div>

                            <div class="form-check">
                                <label class="form-check-label" for="inputReadedGuide">The post will be permanent/at least
                                    for 1 year/at least for 2 years </label>
                                <input class="form-check-input" type="checkbox" name="prepare" id="prepare"
                                    value="yes" required>

                            </div>
                            <div class="form-check">
                                <label class="form-check-label" for="inputReadedGuide">Promotional articles are not
                                    allowed</label>
                                <input class="form-check-input" type="checkbox" name="snapshot" id="snapshot"
                                    value="yes" required>
                            ...
                            <div class="form-check">
                                <label class="form-check-label" for="inputReadedGuide">Please confirm that you have read
                                    and followed the guide. </label>
            ...
            if (websiteUrl) {
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.exists) {
                            $('#inputWebUrl').addClass('is-invalid').next('.invalid-feedback').text(
                                response.message).show();
                            submitButton.prop('disabled', true);
                        } else {
                            $('#inputWebUrl').removeClass('is-invalid').next('.invalid-feedback').text(
                                '').hide();
