        ...
        <section class="border rounded p-5 mt-5">
            <div class="row justify-content-center">
                <div class="col-md-12">
                    ...
                    @endif
                    <form method="POST" action="{{ route('lslbadmin.user.update', $user->id) }}" class="needs-validation"
                        id="user-update-form" novalidate>
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-12 col-md-6 fv-plugins-icon-container">
                                ...
                                <select name="identity" id="inputIdentity" class="form-select">
                                    <option value="individual link builder"
                                        {{ $user->identity == 'individual link builder' ? 'selected' : '' }}>Individual
                                        Link Builder</option>
                                    <option value="in-house team"
                                        {{ $user->identity == 'in-house team' ? 'selected' : '' }}>In-House Team</option>
                                    <option value="agency" {{ $user->identity == 'agency' ? 'selected' : '' }}>Agency
                                    </option>
                                </select>
                            </div>
                            <div class="mb-3 col-12 col-md-6 fv-plugins-icon-container">
                            ...
                            <div class="mb-3 col-12 col-md-6 fv-plugins-icon-container">
                                ...
                                <select name="country" id="inputCountry" class="form-select"
                                    ...
                                    <option value="india" {{ $user->billing_country == 'india' ? 'selected' : '' }}>
                                        india</option>
                                </select>
                            ...
                            <div class="mb-3 col-12 col-md-6 fv-plugins-icon-container">
                                ...
                                <select name="preferred_method" id="inputPreferredMethod" class="form-select">
                                    <option value="paypal" {{ $user->preferred_method == 'paypal' ? 'selected' : '' }}>
                                        PayPal</option>
                                    <option value="stripe" {{ $user->preferred_method == 'stripe' ? 'selected' : '' }}>
                                        Stripe</option>
                                    <option value="razorpay"
                                        {{ $user->preferred_method == 'razorpay' ? 'selected' : '' }}>Razorpay</option>
                                </select>
                            </div>
                            <div class="mb-3 col-12 col-md-6 fv-plugins-icon-container">
                            ...
                            <div class="mb-3 col-12 col-md-6 fv-plugins-icon-container">
                                ...
                                <select name="email_verified_at" id="inputEmailVerified" class="form-select">
                                    <option
                                        value="{{ empty($user->email_verified_at) || $user->email_verified_at == null ? date('Y-m-d H:i:s') : $user->email_verified_at }}"
                                        {{ !empty($user->email_verified_at) ? 'selected' : '' }}>Verified</option>
                                    <option value=""
                                        {{ empty($user->email_verified_at) || $user->email_verified_at == null ? 'selected' : '' }}>
                                        Unverified</option>
                                </select>
                            </div>
                            ...
                            @if ($user->role->name == 'Advertiser')
                                ...
                                <div class="mb-3 col-12 col-md-6 fv-plugins-icon-container">
                                    ...
                                    <input class="form-control" type="number" name="postal_code"
                                        value="{{ $user->postal_code }}" id="inputPostalCode"
    ...
    <script>
        ...
        fetch('<?= url('public/json/country.json') ?>').then(response => response.json()).then(data => {
            ...
            data.map(function($v) {
                ...
                $opt1 = '<option value="' + ($v.name).toLowerCase() + '" data-code="' + $v.dial_code +
                    '" ' + $slct1 + '>' + $v.name + '</option>';
